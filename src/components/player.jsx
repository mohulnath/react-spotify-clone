...
const player = () => {
  ...
  const { seekBar, seekBg, play, pause, playstatus , track , time , after , before , seekbrclick} = useContext(playercontext)
    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className='flex flex-col items-center gap-1 m-auto'>
        ...
        <div className='flex items-center gap-5'> 
          ...
          <div ref={seekBg} onClick={seekbrclick} className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
